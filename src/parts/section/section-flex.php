                ...
                echo '<div class="section__inner">';
                    ...
                    if ($section_title) : 
                        echo '<div class="section__title-wrap">';
                            ...
                            if ( $section_description ) :
                                echo '<p class="section__description">'.$section_description.'</p>';
                            endif;   
                    
                        echo '</div><!-- .section__title-wrap -->';
                    endif;
                    ...
                    while ( have_rows('section_flex') ) : the_row();
                        ...
                        elseif( get_row_layout() == 'flex_gist' ): 
                            ...
                            echo '</div>';
                        elseif( get_row_layout() == 'flex_iframe' ): 

                            echo '<div class="section__iframe">';
                                the_sub_field('section_iframe');
                            echo '</div>';
